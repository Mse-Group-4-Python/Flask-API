...
def add_instrument():
    ...
    instrument_2 = Instrument(id=2, instrument_name="Marimba", manufacturer_id=2, category_id=2 ,description="The marimba (/mərimbə/) is a musical instrument in the percussion family that consists of wooden bars that are struck by mallets", color="Wood", tags="Aerophones")
    ...
    instrument_4 = Instrument(id=4, instrument_name="Shekere", manufacturer_id=3, category_id=5 ,description="It is made of hardwood and generally has a calfskin hide. Nowadays, goatskin is sometimes used, in imitation of the high sound of the popular djembe drum.", color="Natural trumpets", tags="Membranophones")
    instrument_5 = Instrument(id=5, instrument_name="Steelpan", manufacturer_id=5, category_id=6 ,description="The steelpan (also known as a pan, steel drum, and sometimes, collectively with other musicians, as a steelband or steel orchestra) is a musical instrument originating in Trinidad and Tobago. Steelpan musicians are called pannists.", color="Black", tags="Aerophones")
    instrument_6 = Instrument(id=6, instrument_name="Tambourine", manufacturer_id=4, category_id=3 ,description="The tambourine is a musical instrument in the percussion family consisting of a frame, often of wood or plastic, with pairs of small metal jingles, called 'zills'.", color="Red", tags="Idiophones")
    ...
    instrument_18 = Instrument(id=18, instrument_name="Theaphone", manufacturer_id=9, category_id=4 ,description="Traditionally strapped over the shoulder, alfaias are played with a distinctive technique in which players hold the weak-hand drum stick inverted to get the proper attack on the head. ", color="White", tags="Idiophones")
    instrument_19 = Instrument(id=19, instrument_name="Guaslap", manufacturer_id=10, category_id=10 ,description="Vibraslap has a characteristic deep, heavy sound, different from other bass drums such as the surdo or kick-drum", color="Wood", tags="Membranophones")
...
def add_instrucment_item():
    ...
    instrument_item_10 = InstrumentItem(id=10, instrument_id=21, serial_number="56.211.2", description="Cambodia", year_of_purchase=2007 ,price=47668)
    instrument_item_11 = InstrumentItem(id=11, instrument_id=20, serial_number="2451.211.2", description="Cambodia", year_of_purchase=2019 ,price=886556565)
    instrument_item_12 = InstrumentItem(id=12, instrument_id=19, serial_number="1341.311", description="China", year_of_purchase=2017 ,price=123000000)
    instrument_item_13 = InstrumentItem(id=13, instrument_id=18, serial_number="451.221.1", description="Greece", year_of_purchase=2019 ,price=34500000)
    instrument_item_14 = InstrumentItem(id=14, instrument_id=17, serial_number="56.221-7", description="Curdo-persiano", year_of_purchase=2024 ,price=8754300000)
    instrument_item_15 = InstrumentItem(id=15, instrument_id=16, serial_number="242.221-8", description="Thailand", year_of_purchase=1999 ,price=5654500000)
    instrument_item_16 = InstrumentItem(id=16, instrument_id=15, serial_number="545.24", description="India", year_of_purchase=1789 ,price=19750000)
...
def add_customer_order():
    customer_order_1 = CustomerOrder(id=1, customer_name="Trang", delivery_address="95 Le Van Sy",
                                      phone_number="0392391585",order_time= datetime(2012,3,3,10,10,10,10) ,total_price=1)
